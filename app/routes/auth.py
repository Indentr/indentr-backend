...
def post_user_registration(body: UserRegisterRequest):
    ...
    try:
        ...
        practice_id = create_new_practice(body.practice_name, body.practice_email, body.practice_url, body.address, body.phone, body.triage_email, body.triage_email_password)
