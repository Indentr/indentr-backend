...
def post_user_registration(body: UserRegisterRequest):
    ...
    try:
        ...
        create_custom_prompt(
            ...
            "Dental note",
            """Convert the dental dictation transcript into a professional, beautiful and comprehensive dental note for patient record inclusion. The note should also include a section that states "No change in medical history since last appointment" (unless otherwise stated). No need to include any unmentioned sections e.g patient name""",
            "<p></p>",
        )
        create_custom_prompt(
            new_user["_id"],
            ...
            """Convert the above dental dictation transcript into a professional, concise but comprehensive dental treatment plan for patient record inclusion. Only include sections from the example that are relevant. Convert the dental dictation transcript into a professional, beautiful and comprehensive dental treatment plan for patient record inclusion """,
            """<p><strong>1. Consultation and Assessment</strong></p><p></p><p></p><p><strong>2. Pre-Treatment Preparation</strong></p><p></p><p style="text-align: start"></p><p style="text-align: start"><strong>3. Initial Treatment Phase</strong></p><ul><li><p>Procedure</p></li><li><p>Post-Treatment Instructions</p></li></ul><p></p><p><strong>4. Healing and Follow-Up Care</strong></p><p></p><p><strong>5. Secondary Treatment Phase</strong></p><ul><li><p>Procedure<strong>:</strong></p></li><li><p>Post-Treatment Instructions</p></li></ul><p></p><p><strong>6. Final Treatment Phase</strong></p><ul><li><p>Date:</p></li><li><p>Procedure:</p><ul><li><p>Final adjustments or placements</p></li><li><p>Occlusion Check</p></li></ul></li><li><p>Oral Hygiene Instructions</p></li></ul><p></p><p><strong>7. Maintenance and Regular Check-Ups</strong></p>""",
        )

        create_custom_prompt(
            new_user["_id"],
            new_user["practice_id"],
            "Hygiene General note",
            """Convert the hygiene appointment dictation transcript into a professional, beautiful and comprehensive hygiene note for patient record inclusion. The note should also include a section that states "No change in medical history since last appointment"(unless otherwise stated). No need to include any unmentioned sections e.g patient name""",
            """ """,
        )
        ...
        create_custom_prompt(
            new_user["_id"],
            new_user["practice_id"],
            "Hygiene Periodontal Charting note",
            """Convert the hygiene appointment dictation transcript into a professional, beautiful and comprehensive hygiene periodontal charting note for patient record inclusion. ONLY include teeth/pockets mentioned.""",
            """<p><strong>Pocket Depths</strong></p><p><strong>Gum Recession</strong></p><p><strong>Bleeding Sites</strong></p><p><strong>Clinical Observations</strong></p><p><strong>Treatment Recommendations</strong></p>""",
        )

        create_custom_prompt(
            new_user["_id"],
            new_user["practice_id"],
            "Hygiene Prophylaxis Treatment note",
            """Convert the hygiene appointment dictation transcript into a professional, beautiful and comprehensive hygiene prophylaxis treatment note for patient record inclusion. ONLY include teeth/pockets mentioned.""",
            """<p><strong>Pocket Depths</strong></p><p><strong>Gum Recession</strong></p><p><strong>Bleeding Sites</strong></p><p><strong>Clinical Observations</strong></p><p><strong>Treatment Recommendations</strong></p>""",
        )
        ...
        create_custom_prompt(
            new_user["_id"],
            new_user["practice_id"],
            "Hygiene Oral Hygiene Assessment Note",
            """Convert the hygiene appointment dictation transcript into a professional, beautiful and comprehensive oral hygiene assessment note for patient record inclusion.""",
            """<p><strong>Current Oral Hygiene Practices</strong></p><p><strong>Oral Appliance Status</strong></p><p><strong>Oral Health Status</strong></p><p><strong>Hygiene Improvement Plan</strong></p><p><strong>Monitoring Plan</strong></p>""",
        )

        create_custom_prompt(
            new_user["_id"],
            new_user["practice_id"],
            "Hygiene Patient Education and Instruction Note",
            """Convert the hygiene appointment dictation transcript into a professional, beautiful and comprehensive Patient Education and Instruction note for patient record inclusion.""",
            """<p><strong>Hygiene Instructions Given</strong></p><p><strong>Demonstration of Techniques</strong></p><p><strong>Recommended Products</strong></p><p><strong>Dietary Advice</strong></p><p><strong>Follow-Up Instructions</strong></p>""",
        )
