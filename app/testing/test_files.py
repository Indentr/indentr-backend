...
def insert_treatment_plan(register_and_login):
    ...
    treatment_plan_document_template = {
        ...
        "patient_info": {"forename": "Harry", "surname": "Potter", "dob": "1905-01-01", "gender": "Male", "address": "4 Privat drive"},
...
def test_save_nonexistent_treatment_plan(insert_treatment_plan):
    ...
    response = client.post(
        "/files/saveTreatmentPlan",
        json={"treatmentPlan": str(treatment_plan_document_template), "letterId": str(ObjectId())},
        headers={
            "Authorization": f"Bearer {token}",
            "Content-Type": "application/json",
        },
